...
from cubeanim_renderer.animations import CubeMoveConcurrent, CubeMoveExtended
from cubeanim_domain.oll import OLLTopViewData
from cubeanim.palette import CONTRAST_SAFE_CUBE_COLORS, FACE_ORDER
from cubeanim_domain.pll import PLLTopViewData
from cubeanim_renderer.rubik_core import RubikCube3D
from cubeanim_domain.state import state_string_from_moves
from cubeanim_domain.utils import wrap_formula_for_overlay
...
class ExecutionConfig:
    ...
    # Optional: render U (yellow) stickers with a different fill color (e.g. "stickerless" top for F2L tracking).
    mask_u_color: str | None = None
